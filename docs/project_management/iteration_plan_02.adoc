...
| Beginn der Iteration | 06.12.2020
...
== Alphas
Auf grund von Technischen Problemen der Anwendung war das Darstellen der Alphas in dieser Iteration leider nicht möglich.
...
https://github.com/jonashoelzel/ZEISS_Verwaltungssystem/projects/2


== Bewertungskriterien
//Eine kurze Beschreibung, wie Erfüllung die o.g. Ziele bewertet werden sollen.
* Positive Rückmeldung von Herr Lösch
...
[%header, cols="1,3"]
|===
| Assessment Ziel | Gesamt Projekt
| Assessment Datum | 13.12.2020
| Teilnehmer | Paul, Nina
| Projektstatus	| grün
|===

* *Beurteilung im Vergleich zu den Zielen* +
//Dokumentieren Sie, ob die angestrebten Ziele des Iterationsplans erreicht wurden.
Die Gestzten Ziele wurden erreicht
...
Alle Aufgaben wurden in dem Gegebenen Zeitraum erledigt.
...
Die Wireframes wurden mit Änderungen versehen. diese Änderungen wurden Umgesetzt und von Herr Lösch abgesegnet (am 23.12.)
