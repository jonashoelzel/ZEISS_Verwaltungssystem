...
| Initial Meeting  | 22.11.2020
| Rollenaufteilung | 22.11.2020
| Einrichtung Repository | 23.11.2020
| Zwischen Meeting | 29.11.2020
| Use case 1-5 | 0
| Visions Doc. | 03.12.2020
| Initiales Treffen mit Aufgabensteller | 04.12.2020 
| 
...
* Einrichtung der verwendeten Werkzeuge
* Vision
* Standard-Usecase
* Initiale Rsik analyse
* Stakeholder Analyse
* Prototypen scope
* Anforderungsanalyse
* Rollenaufteilung
* Erreichung LCO Meilenstein
...
| Einrichtung Repository | 1 | 1 | done | x | I1 | Jonas Hölzel | 0,5 | 0
|  | |||||||
|||||||||
|||||||||
|||||||||
...
| Assessment Datum | 06.12.2020
| Teilnehmer | Team vollständig
...
*** Roadmap (Trello) gut wird aber durch Issue ersetz werden
*** Discord organisiert, aber nicht hohe qualität
