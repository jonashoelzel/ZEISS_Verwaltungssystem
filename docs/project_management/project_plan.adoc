...
Wie vorgeschrieben wird in iterativen abläufen gearbeitet werden. Grundlage dafür wird der OpenUP sein. 
...
* Initiale Grenzen Analyse
* Stakeholder Analyse
* Prototypen scope
| Date from 23.11.2020 +
Date to 06.12.2020
| 15
...
* Wireframes
* development Protoyp
* Überarbeitung Usecases
* Mögliche Features werden Aufgelistet 
* Risikominimierungs-Strategien umsetzen
| Date from 07.12.2020 + 
Date to 20.12.2020
| 16
| I3 
| 
* testing und implementing von Prototyp
* Architekturplan
* Priorisierung möglicher Features
| Date from 04.01.2021 +
Date to 17.01.2021
| 20
| 
|===
