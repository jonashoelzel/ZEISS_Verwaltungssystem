...
| Nina Püschmann | Administration | Analyst |
| Stephan Joneleit | Implementation | Developer | "C#/.NET"
| Vanessa Bayer | Implementation | Tester |
| Jonas Hölzel | Logic | Architect/Developer |
| Jean-Pierre  Kaiser | Logic | Tester |
| Oliver Wünsche | UI | Developer |
| Peter Holland-Moritz | UI | Tester |
|===
