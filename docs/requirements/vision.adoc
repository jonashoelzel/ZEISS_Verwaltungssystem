...
Dieses Visions-Dokument bezieht sich auf das ZEISS-Verwaltungssystem, das von <Team> entwickelt wird. Das System wird es ZEISS erlauben, <Hauptfunktionen> zu nutzen, um damit <Vorteile> zu erreichen / <Aufgabe> zu erleichtern / <Problem> zu lösen.
...
|Gesetzgeber|x|prüft Einhaltung des Rechtes|gering|gering-mittel|neutral
|===
