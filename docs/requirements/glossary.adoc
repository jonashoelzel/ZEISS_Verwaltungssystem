...
== Tabellen-Spoaltenbezeichnungen
[%header]
|===
...
|Veröffentlichungsdatum|Datum, an dem die Publikation von einem Publisher veröffentlicht wurde|DATE|VALID DATE|Date-of-release
